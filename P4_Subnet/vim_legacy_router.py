...
def myNetwork():
        ...
        # IP Range of 192.168.1.1 - 192.168.1.255 
        ...
        net.addLink(h1, r1, intfName2='r1-eth1', params2={ 'ip' : '192.168.1.1/24' } )
        # Creates a link between r1(router) to host h2
        net.addLink(h2, r1, intfName2='r1-eth2', params2={ 'ip' : '192.168.2.1/24' } )
